...
uint8_t I2C_EE_ByteRead(uint8_t EEPROM_HW_ADDRESS, uint16_t ReadAddr);
//void EEPROM_read_mem(uint8_t hw_addr, uint8_t eeprom_addres,const void* pData , int size); 
